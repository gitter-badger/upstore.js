...
(function() {
	var UPSTORE_LANDSCAPE = window.location.href.indexOf("stagingapi.upstore.io") > -1 || document.querySelector("[upstore-framework]").getAttribute('src') == 'http://staging.upstore.io/upstore.js' ? 'STAGING' : 'PRODUCTION';
	...
	window.UPSTORE = {
		 ...
		 */
		server: {
			base: UPSTORE_LANDSCAPE == 'STAGING' ? "http://stagingapi.upstore.io" : 'http://api.upstore.io',
			azure: UPSTORE_LANDSCAPE == 'STAGING' ? "https://stagingupstore.blob.core.windows.net" : "https://upstore.blob.core.windows.net",
